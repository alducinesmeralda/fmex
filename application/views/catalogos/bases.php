        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>catalogos/nuevaBase"><i class="fa fa-plus"></i> Nuevo</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <form action="<?php echo base_url() ?>catalogos/bases" method="POST" id="searchList">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            ?>
                                    <tr id="tr_<?php echo $record->id_base ?>">
                                        <td><?php echo $record->id_base ?></td>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-info" href="<?php echo base_url() . 'catalogos/editarBase/' . $record->id_base; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger delete" href="#" data-id="<?php echo $record->id_base; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery('ul.pagination li a').click(function(e) {
            ...
            console.log('ir a '  + baseURL + "catalogos/bases/" + value);
            // debugger;
            jQuery("#searchList").attr("action", baseURL + "catalogos/bases/" + value);
