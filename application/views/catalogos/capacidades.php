<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-file"></i> Capacidades
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>catalogos/nuevaCapacidad"><i class="fa fa-plus"></i> Nuevo</a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Capacidades</h3>
                        <div class="box-tools">
                            <form action="<?php echo base_url() ?>catalogos/capacidades" method="POST" id="searchList">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <?php
                            if (!empty($capacidadRecords)) {
                                foreach ($capacidadRecords as $record) {
                            ?>
                                <tr id="tr_<?php echo $record->id_capacidad ?>">
                                        <td><?php echo $record->id_capacidad ?></td>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-sm btn-info" href="<?php echo base_url() . 'catalogos/editarCapacidad/' . $record->id_capacidad; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-sm btn-danger delete" href="#" data-id="<?php echo $record->id_capacidad; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery('ul.pagination li a').click(function(e) {
            ...
            console.log('ir a '  + baseURL + "catalogos/capacidades/" + value);
            // debugger;
            jQuery("#searchList").attr("action", baseURL + "catalogos/capacidades/" + value);
        ...
        jQuery(document).on("click", ".delete", function() {
            var id = $(this).data("id"),
                hitURL = baseURL + "deleteCapacidad";
