<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-licencias"></i> Licencias
    </h1>
  </section>
    ...
    <div class="row">
      <div class="col-xs-12 text-right">
        <div class="form-group">
          <a class="btn btn-primary" href="<?php echo base_url(); ?>catalogos/nuevaLicencia"><i class="fa fa-plus"></i> Nuevo</a>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools">
              <form action="<?php echo base_url() ?>catalogos/licencias" method="POST" id="searchList">
          ...
          <div class="box-body table-responsive no-padding">
            <table class="table table-hover">
              ...
              <?php
              if (!empty($licenciaRecords)) {
                foreach ($licenciaRecords as $record) {
              ?>
                  <tr id="tr_<?php echo $record->id_licencia ?>">
                    <td><?php echo $record->id_licencia ?></td>
                    <td><?php echo $record->nombre ?></td>
                    <td><?php echo date("d-m-Y", strtotime($record->fecha_alta)) ?></td>
                    <td class="text-center">
                      <a class="btn btn-sm btn-info" href="<?php echo base_url() . 'catalogos/editarLicencia/' . $record->id_licencia; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                      <a class="btn btn-sm btn-danger delete" href="#" data-id="<?php echo $record->id_licencia; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
              <?php
                }
...
<script type="text/javascript">
  jQuery(document).ready(function() {
    jQuery('ul.pagination li a').click(function(e) {
      ...
      jQuery("#searchList").attr("action", baseURL + "licencias/" + value);
