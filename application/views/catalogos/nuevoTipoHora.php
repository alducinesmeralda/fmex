<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-file"></i> Tipo hora
            <small>Nuevo</small>
        </h1>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="nuevaTipoHora" action="<?php echo base_url() ?>insertarTipoHora" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
...
<script src="<?php echo base_url(); ?>assets/js/nuevaTipoHora.js" type="text/javascript"></script>